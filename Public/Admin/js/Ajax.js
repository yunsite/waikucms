function CheckName() {
	...
	{
		enter_name.innerHTML = "<img src='../images/check_err.gif' height='13' width='13'>&nbsp;<font color='#FF0000'>?????????§³??2?????</font>";
	return false;
	}
	...
	return false;
		...
		if(text=="WordErr")
		{
			enter_name.innerHTML = "<img src='../images/check_err.gif' height='13' width='13'>&nbsp;<font color='#FF0000'>?????????????§Ü??§Ò????????????</font>";
			return false;
		}
		if(text=="True")
		{
...
function UserPassword_enter()
{
	...
	{
		enter_pwd.innerHTML = "<img src='../images/check_err.gif' height='13' width='13'>&nbsp;<font color='#FF0000'>????????????§Õ</font>";
	}
	if(document.UserReg.UserPassword.value.length<5)
	{
		enter_pwd.innerHTML = "<img src='../images/check_err.gif' height='13' width='13'>&nbsp;<font color='#FF0000'>???????????????¦Ë</font>";
	}
	if(document.UserReg.UserPassword.value.length>5)
	{
...
function user_from()
{
	...
	if(document.UserReg.UserPassword.value.length<1)
	{
		enter_pwd.innerHTML = "<img src='../images/check_err.gif' height='13' width='13'>&nbsp;<strong><font color='#ff0000'>????????????§Õ</font></strong>";
		document.UserReg.UserPassword.focus();
		return false;
	}
	if(document.UserReg.UserPassword.value.length<5)
	{
		enter_pwd.innerHTML = "<img src='../images/check_err.gif' height='13' width='13'>&nbsp;<strong><font color='#ff0000'>???????????????¦Ë</font></strong>";
		document.UserReg.UserPassword.focus();
		return false;
	}
	if(document.UserReg.PwdConfirm.value != document.UserReg.UserPassword.value)
